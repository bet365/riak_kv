...
%% TODO: consider changing this logic, its not doing much! (function can be much simpler)
...
encode_disk_key(<<?VERSION_2:7, Type:1, Rest/bits>>, Opts) ->
    TstampExpire = proplists:get_value(Opts, ?TSTAMP_EXPIRE_KEY, ?DEFAULT_TSTAMP_EXPIRE),
